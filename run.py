...
if __name__ == "__main__":
    ...
    x = 0
    for diction in data1:
        for num, stats in diction.items():
    ...
    save = r'C:\Users\Flynn\OneDrive\Desktop\temp\rs_output_final3.xlsx'
